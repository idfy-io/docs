...
request({
  ...
  form: {
    ...
    //Then when we get the response, we parse the access token, and make some test data for the signature request
        ...
        request({
            ...
            auth:{
                ...
                if(!error && response.statusCode==200){
                    ...
                    console.log("but it gives an example of how this file looks:");
                    console.log(body);
